    ...
    const founders: FounderSpec[] = [
      {
        ...
        genres: ["Indie", "Soul"],
        bio: "Runs Inner Soul Records and still writes guitar parts after the office lights go off. Looking after the roster.",
        songId: "martin-1",
      ...
      },
      {
        ...
        genres: ["Soul", "Jazz"],
        bio: "Voice first, paperwork second. Inner Soul on weekdays, the stage on weekends.",
        songId: "sinlam-1",
