export const EN = {
  ...
  kindMusician: "Musician",
  instrumentPlayed: "Instrument played",
  instrumentPlaceholder: "Guitar, piano, drums\u2026",
  artistRegisterHint: "You can upload your first track later from Me. Once a track is approved, you\u2019ll join the roster with a verified tag.",
  locIsland: "HK Island",
  locKowloon: "Kowloon",
  ...
  continuousPlayLoop: "Loop music",
  allowContinuousPlay: "Allow continuous play",
  allowContinuousPlayHint: "Lets this business account turn on looping in the player so music keeps going after each track.",
  ...
  servicesNote: "Publishing, composing, live music, shop",
  ...
  cardComposeKicker: "Songwriting",
  cardComposeTitle: "Composing and lyrics writing",
  cardComposeBody: "Original music and lyrics for your project. Tell us what you need — we\u2019ll write back on WhatsApp.",
  ...
  cardShopBody: "Ukuleles in stock — Ghost series and more. Tap through to enquire.",
  bookings: "Bookings",
  ...
  composingTitle: "Composing and lyrics writing",
  composingIntro: "Original composing and lyrics for artists and projects in Hong Kong. Leave a WhatsApp number and a short brief so we can quote you.",
  composingService: "What you need",
  composingProject: "Project type",
  composingLanguage: "Lyrics language",
  composingGenre: "Genre / style",
  composingGenrePlaceholder: "Indie, hip-hop, ballad\u2026",
  composingBrief: "About your project",
  composingType: "Composing & lyrics",
  composeOnly: "Composing",
  lyricsOnly: "Lyrics",
  composeAndLyrics: "Composing and lyrics",
  composeProjectFull: "Full song",
  composeProjectMelody: "Melody only",
  composeProjectLyrics: "Lyrics only",
  composeProjectLyricsFor: "Lyrics for your melody",
  ...
  theShop: "The shop",
  shopIntro: "Instruments in stock. Tap one to enquire — we\u2019ll write on WhatsApp.",
  ...
  errUsernameTaken: "That login name is already in use. Please choose another.",
  errEmailTaken: "That email is already registered. Please use another or log in.",
  errNameRole: "Name and role are required.",
  errInstrumentRequired: "Instrument is required.",
  ...
  gateEventBody: "Events are posted by verified artists, then approved by Inner Soul Records. Register as an artist and get a track approved to begin.",
  gateVerifyTitle: "Verification required",
  gateVerifyBody: "This is reserved for artists Inner Soul Records has verified. Upload a track from Me, then wait for approval to join the roster.",
