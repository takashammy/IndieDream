...
const ZH: Record<Msg, string> = {
  ...
  saved: "已儲存",
  changePhoto: "更換頭像",
  guestBrowse: "訪客可瀏覽目錄。聆聽、留言板、活動及服務需登入帳戶。",
  isrPending: "Inner Soul Records 須通過審批後方可上架。",
  ...
  postEvent: "發佈活動",
  postAnEvent: "發佈活動",
  eventApproval: "所有活動須經 Dreamin' Indie 管理員審批。",
  sentForReview: "已送出審批。所有活動須經 Dreamin' Indie 管理員批准。",
  title: "標題",
  date: "日期",
  time: "時間",
  venue: "場地",
  ...
  cardShopKicker: "店舖",
  cardShopTitle: "Inner Soul Instruments",
  cardShopBody: "店內備有 Ukulele。Concert、Soprano、Tenor、Baritone — 即買即彈。",
  bookings: "預訂",
  ...
  backServices: "← 服務",
  theShop: "店舖",
  shopIntro: "以 Ukulele 為主。選擇型號查詢，我們會為你預留。",
  enquirySent: "查詢已送出。",
  note: "備註",
  enquire: "查詢",
  ...
  errEmail: "請輸入有效電郵。",
  errUsernameTaken: "此用戶名稱已被使用。",
  errEmailTaken: "此電郵已經註冊。",
  errNameRole: "請填寫名稱及崗位。",
  errUploadTrack: "請上載一首歌曲供我們審批。",
  errWrong: "用戶名稱或密碼不正確。",
  errNoAccount: "沒有帳戶使用此電郵。",
  errRemoved: "此帳戶已從 Dreamin' Indie 移除。",
  errShortPass: "密碼太短。",
  ...
  gateEventBody: "活動由已認證音樂人發佈，並經 Inner Soul Records 審批。請以音樂人身份註冊並上載一首歌曲開始。",
  gateVerifyTitle: "需要認證",
  gateVerifyBody: "此功能僅限 Inner Soul Records 已認證的音樂人。請上載歌曲，然後等待審批。",
