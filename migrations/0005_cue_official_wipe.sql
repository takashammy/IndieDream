-- Official launch wipe. Runs once on the next deploy even if 0004 already applied.
-- Preview accounts and user posts/notices go. Catalogue artists reload from app code.
