-- Wipe every account, session, and catalog profile again,
-- including leftover Martin Sham / Sin Lam rows that local
-- snapshots may have written back after earlier wipes.
