-- Full login wipe. Runs once on the next deploy, after 0005/0006.
-- Deletes every account including admin, Martin, and Sin Lam.
-- Catalogue artist pages still come from app code. Sessions go so nobody stays signed in.
